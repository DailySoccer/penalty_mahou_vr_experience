...
/**
 ...
 If you want to use this feature, Ad4Screen servers will send all messages information to your app, but you will need to handle yourself the display part
 */
